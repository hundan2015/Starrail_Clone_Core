...
struct RipHomeRun : public Skill {
    std::array<float, 12> percent = { 0.625, 0.6975, 0.75, 0.8125, 0.875, 0.9375, 1.015625, 1.09375, 1.171875, 1.25, 1.3125, 1.375 };
    RipHomeRun()
    {
        targetCount = 3;
...
struct TrailBlazerPhysic : public Character {
    TrailBlazerPhysic()
    {
        ...
        skills.push_back(std::unique_ptr<FarewellHit>(new FarewellHit()));
        skills.push_back(std::unique_ptr<RipHomeRun>(new RipHomeRun()));
    }
};
